...
<p align="center">NPM package for my custom Draggable React Slider using React Spring and GSAP.

![gif](https://media.giphy.com/media/gKNT6B5MkMnp4sHMiT/giphy.gif)</p>
